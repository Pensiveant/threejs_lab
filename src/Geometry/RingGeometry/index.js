...
// 创建圆环
const geometry = new THREE.RingGeometry(1, 2, 30);
...
//
const geometry2 = new THREE.RingGeometry(1, 2, 4);
const mesh2 = new THREE.Mesh(geometry2, material);
scene.add(mesh2);
mesh2.position.set(0, 0, 5);

// 
const geometry1 = new THREE.RingGeometry(1, 2, 5, 30);
const mesh1 = new THREE.Mesh(geometry1, material);
scene.add(mesh1);
mesh1.position.set(5, 0, 0);

// 半圆环
const geometry5 = new THREE.RingGeometry(
  1,
  2,
  20,
  20,
