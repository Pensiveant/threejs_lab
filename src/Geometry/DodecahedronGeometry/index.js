...
//
const geometry2 = new THREE.DodecahedronGeometry(2, 3);
...
// 
const geometry1 = new THREE.DodecahedronGeometry(2, 10);
const mesh1 = new THREE.Mesh(geometry1, material1);
scene.add(mesh1);
mesh1.position.set(5, 0, 0);

// 
const geometry5 = new THREE.DodecahedronGeometry(2, 0);
